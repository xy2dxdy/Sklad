...
CREATE TABLE `productsgroups` (
  `idProductsGroups` int NOT NULL AUTO_INCREMENT,
  `name` varchar(45) NOT NULL,
  PRIMARY KEY (`idProductsGroups`)
...
INSERT INTO `productsgroups` VALUES (1,'asd'),(2,'sdf'),(3,'fgfh'),(4,'Компьютеры'),(5,'Телефоны'),(6,'Ноутбуки');
