...
import kpclient.modules.CreateNewUserModule;
...
public class CreateNewUserController implements Initializable
{
    ...
    private CreateNewUserModule createNewUserModule;
    private User user;
    ...
    {
        createNewUserModule = new CreateNewUserModule(this);
    }
    ...
    {
        CreateNewUserResponse createNewUserResponse = createNewUserModule.CreateNewUser(setUser());
        OnBackButtonClicked(event);
        if(createNewUserResponse.accepted == true)
        {
            Alert alert = new Alert(Alert.AlertType.INFORMATION);
            alert.setTitle("Успешно");
            alert.setHeaderText(null);
            alert.setContentText("Информация о пользователе успешно добавлена");
        ...
        else
        {
            ...
            alert.setHeaderText(null);
            alert.setContentText("Не удалось добавить информацию о пользователе");
